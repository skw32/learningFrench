'''
TODO/ issues:
- Issue with verb hint method
- Add option to show hint in second cloud after pressing h
- Show other random false verbs at the same time
- Add win point for good verb match and lose for bad verbs
- Update verbs
...
class SpaceShooter(arcade.Window):
    ...
    def setup(self):
        ...
        # Single static en verb
        img2 = Image.new('RGB', (80, 20), color = (255, 255, 255))
        d2 = ImageDraw.Draw(img2)
        translation = current_word.fr_verb.encode('utf8')
    ...
    def on_update(self, delta_time: float):
        ...
        # Generate a list of all verbs that collided with the player, gain a point
        hit_list = arcade.check_for_collision_with_list(self.player, self.verb_sprite_list)
        # Loop through each colliding sprite, remove it, and add to the score.
        for verb in hit_list:
    ...
    def on_draw(self):
        ...
        arcade.draw_text("h pour un indice:", 1205, 1110, arcade.color.BLACK, 20)
